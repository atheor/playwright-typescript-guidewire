# Playwright TypeScript Guidewire — Framework Documentation
...
6. [Layer Guide](./layers.md)
7. [Test Data Management](./test-data.md)
8. [SOAP & D365 Integration](./soap-integration.md)
